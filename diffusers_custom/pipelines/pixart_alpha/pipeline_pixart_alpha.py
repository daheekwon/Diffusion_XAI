...
class PixArtAlphaPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        ablate_channels: Optional[List[Dict]] = None,
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if (ablate_channels is not None) and (i < len(ablate_channels)-1):
                ...
                transformer_output = self.transformer(
                    ...
                    return_dict=False,
                    return_latents=return_latent,
                    ablate_channels=abl_channels,
                )
                
                if return_latent:
                    noise_pred, feature = transformer_output
        ...
        if not return_dict:
            return (image,)
        if return_latent:
            return ImagePipelineOutput(images=image), features
